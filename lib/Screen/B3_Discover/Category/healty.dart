...
import '../../B1_Home_Screen/Detail/detail_recipe.dart';

class healtyDiscover extends StatefulWidget {
  String idUser;
  healtyDiscover({this.idUser});

  _healtyDiscoverState createState() => _healtyDiscoverState();
}

class _healtyDiscoverState extends State<healtyDiscover> {
  ///
                ...
                Padding(
                    ...
                    child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          .collection("recipe")
                          .where('category', isEqualTo: 'Healty')
                          .snapshots(),
