...
class breakfastDiscover extends StatefulWidget {
  String idUser;
  breakfastDiscover({this.idUser});

  _breakfastDiscoverState createState() => _breakfastDiscoverState();
}

class _breakfastDiscoverState extends State<breakfastDiscover> {
  ///
