...
class lunchDiscover extends StatefulWidget {
  String idUser;
  lunchDiscover({this.idUser});

  _lunchDiscoverState createState() => _lunchDiscoverState();
}

class _lunchDiscoverState extends State<lunchDiscover> {
  ///
