...
class _AddRecipeState extends State<AddRecipe> {
  ...
  Future getImage() async {
    var image = await File(await ImagePicker().getImage(source: ImageSource.gallery).then((pickedFile) => pickedFile.path));
  ...
  Future uploadPic(BuildContext context) async {
    ...
    var dowurl = await uploadTask.then((res) {
  ...
  Future selectPhoto() async {
    var img = File(await ImagePicker().getImage(source: ImageSource.gallery).then((pickedFile) => pickedFile.path));
      setState(() {
        _image = img;
